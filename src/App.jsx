  ...
  return (
    <> 
      ...
      <div className="h-screen" style={{ display: mostraLogin ? "none" : "" }}>
        <NavBar />
        <div className="flex flex-col items-center justify-center h-5/6" style={{ display: currentURL.includes("inicio") ? "" : "none" }}>
          <img
            alt="Your Company"
        ...
        <div className="flex flex-col items-center justify-center h-5/6" style={{ display: currentURL.includes("horario") ? "" : "none" }}>
         <DataHora />
         </div>
      </div>
